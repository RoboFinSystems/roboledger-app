        ...
        >
          ...
          <nav className="hidden items-center space-x-5 lg:flex lg:space-x-6">
            ...
            <a
              ...
              // Hidden at lg so the row still fits with Docs added; the mobile menu and
              // the footer carry it there.
              className="hover:text-primary-400 hidden p-2 text-gray-400 transition-colors xl:block"
            >
