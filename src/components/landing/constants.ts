 ...
 * sections, header, and footer. Harbinger FinLab implements RoboLedger and trains
 * the people who run it (practices, finance teams); it never runs a customer's
 * books. It is deliberately NOT a RoboSystems "app" (it isn't in
