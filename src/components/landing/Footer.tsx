        ...
        <div className="grid gap-4 md:grid-cols-5 lg:gap-6">
          <div className="md:col-span-2">
            ...
            <p className="mb-4 max-w-md text-sm text-gray-400">
              Open-source knowledge graph platform for financial and operational
              intelligence. Transform your data into a semantic layer that AI
              agents can understand and reason over.
            </p>
