...
const MOCK_TRIAL_BALANCE: TrialBalanceRowWithGraph[] = [
  // Assets
  {
    accountId: 'cash-and-equivalents',
  ...
  },
  {
    ...
    classification: 'equity',
    totalDebits: 0,
    totalCredits: 7500000,
    netBalance: -7500000,
    _graphId: 'demo-graph-1',
    _graphName: 'acme-corp',
  },
  // Revenue (offset entries from income statement closing)
  {
    accountId: 'product-revenue',
    accountName: 'Product Revenue',
    classification: 'revenue',
    totalDebits: 0,
    totalCredits: 18500000,
    netBalance: -18500000,
    _graphId: 'demo-graph-1',
    _graphName: 'acme-corp',
  },
  ...
  // Expenses
  {
    accountId: 'cost-of-revenue',
    accountName: 'Cost of Revenue',
    classification: 'expense',
    totalDebits: 11750000,
    totalCredits: 0,
    netBalance: 11750000,
    _graphId: 'demo-graph-1',
    _graphName: 'acme-corp',
  ...
  {
    accountId: 'research-development',
  ...
  useEffect(() => {
    const loadTrialBalance = async () => {
      try {
        ...
        // Use mock data if no real data found (for screenshots)
        if (allRows.length === 0) {
          setData(MOCK_TRIAL_BALANCE)
        } else {
          setData(allRows)
        }
      } catch (err) {
